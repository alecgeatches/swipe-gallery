...
function openSwipeGallery(swipeGalleryBlock, swipeGalleryItem, index) {
  ...
  const gallery = new (photoswipe__WEBPACK_IMPORTED_MODULE_0___default())(pswpElement, (photoswipe_dist_photoswipe_ui_default__WEBPACK_IMPORTED_MODULE_1___default()), items, {
    index: index,
